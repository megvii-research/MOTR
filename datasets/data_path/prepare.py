...
root = '/data/workspace/datasets/mot' # for fangao.
# root = '/data/Dataset/mot' # for dongbin.
save_path = '/data/workspace/detr-mot/datasets/data_path/mot17_cuhk_ethz.train' # for fangao
# save_path = '/data/dongbin/projects/e2e_detmot/datasets/data_path/mot17_cuhk_ethz.train'  # for dongbing.
dataset_list = ['MOT17', 'CUHK-SYSU', 'ETHZ', 'PRW']
# dataset_list = ['MOT17', ]
