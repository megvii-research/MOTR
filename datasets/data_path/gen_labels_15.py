...
seq_root = '/data/workspace/datasets/mot/MOT15/images/train'
label_root = '/data/workspace/datasets/mot/MOT15/labels_with_ids/train'
mkdirs(label_root)
...
for seq in tqdm(seqs):
    ...
    all_imgs = os.listdir(osp.join(seq_root, seq, 'img1'))
    fm = cv2.imread(osp.join(seq_root, seq, 'img1', all_imgs[0]))
