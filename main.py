...
def get_args_parser():
    ...
    parser.add_argument('--local_self_attn', default=False, action='store_true')
    parser.add_argument('--new_frame_adaptor', default=False, action='store_true')
    ...
    parser.add_argument('--vector_loss_norm', action='store_true')
    parser.add_argument('--activation', default='relu', type=str, help="Activation function to use")
    parser.add_argument('--hr_training', action='store_true')
    parser.add_argument('--fix_lr_training', action='store_true')
    parser.add_argument('--fix_vistr_training', action='store_true')
    parser.add_argument('--fix_vistr_short_training', action='store_true')
    parser.add_argument('--fix_vistr_photo_training', action='store_true')
    parser.add_argument('--aug_type', type=str, default="fixed_vistr")
    parser.add_argument('--random_shift', action='store_true')
    parser.add_argument('--vector_aux_loss_layer', default=[0,1,2,3,4,5], type=str, nargs='+')
    ...
    parser.add_argument('--mot_path', default='./data', type=str)
    ...
    parser.add_argument('--ann_path', default='data/annotations/instances_val_sub.json')
    ...
    parser.add_argument('--track_embedding_layer', default='SimpleEmbedding', type=str,
                        help="")
    ...
    parser.add_argument('--vector_loss_coef', default=2, type=float)
...
def main(args):
    ...
    datasets2collate_fn = {
        'e2e_mot': utils.mot_collate_fn,
        'mot': utils.mot_collate_fn,
        'bdd100k_mot': utils.mot_collate_fn
    }
    ...
    # lr_scheduler = WarmupMultiStepLR(optimizer=optimizer,milestones=[args.lr_drop])
    ...
    dataset_list = ['e2e_mot', 
                    'bdd100k_mot']
    if args.dataset_file in dataset_list:
