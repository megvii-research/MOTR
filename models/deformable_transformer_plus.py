...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 ...
                 local_self_attn=False, new_frame_adaptor=False, extra_track_attn=False):
        super().__init__()
...
class DeformableTransformerDecoderLayer(nn.Module):
    def __init__(self, d_model=256, d_ffn=1024,
                 dropout=0.1, activation="relu",
                 n_levels=4, n_heads=8, n_points=4, self_cross=True, sigmoid_attn=False, local_self_attn=False, extra_track_attn=False):
        super().__init__()
